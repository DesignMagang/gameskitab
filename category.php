...
<!-- notifikasi berhasil di hapus semua -->
<!-- ?php if (isset($_GET['deleted']) && $_GET['deleted'] == 1): ?>
    <div class="bg-green-200 text-green-800 p-2 rounded my-4">
...
<div class="max-w-xl mx-auto bg-white p-4 rounded shadow">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-2">
        <div class="flex gap-4 flex-wrap items-center" id="navButtons">
          ...
          <!-- Tombol Hapus Semua Pertanyaan -->
          <button onclick="showDeleteModal()" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded ml-2">
              Hapus 
          </button>
          <!-- Tombol tanpa konfirmasi -->
...
<!-- Modal Konfirmasi Hapus Semua tanpa konfirmasi -->
<!-- <div id="deleteModal" class="fixed inset-0 bg-gray-800 bg-opacity-50 hidden justify-center items-center z-50">
    <div class="bg-white rounded-lg shadow-lg p-6 w-96">
        ...
        <p class="mb-4">Apakah Anda yakin ingin menghapus semua pertanyaan dalam kategori ini?</p>
        <div class="flex justify-end space-x-2">
            <button onclick="closeDeleteModal()" class="bg-gray-300 px-4 py-2 rounded hover:bg-gray-400">Batal</button>
            <form method="POST" action="delete_all_questions.php">
...
<div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
  <div class="bg-white p-6 rounded shadow-md text-center">
    <p class="text-lg font-semibold mb-4">Yakin ingin menghapus semua pertanyaan?</p>
    <div class="flex justify-center gap-4">
      <button onclick="deleteAllQuestions()" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded">Hapus</button>
...
<!-- Alert Success -->
<div id="deleteSuccess" class="fixed top-5 right-5 bg-green-500 text-white px-4 py-2 rounded shadow-lg hidden z-50">
  Semua pertanyaan berhasil dihapus.
</div>
    ...
    .then(data => {
        if (data.trim() === 'success') {
            ...
            setTimeout(() => {
                ...
                location.reload(); // Optional: reload untuk update data
            }, 2000);
        }
    });
}
